...
You MUST complete your review within 8 tool calls. Read max 8 files. Focus on changed files only — use `git diff` to identify what changed, then read only those files.
